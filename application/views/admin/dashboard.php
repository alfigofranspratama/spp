        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="card-bx stacked card">
                    <img src="<?= base_url('assets/') ?>images/card/card1.jpg" alt="">
                    <div class="card-info">
            ...
            <div class="col-sm-6">
                <div class="card-bx stacked card">
                    <img src="<?= base_url('assets/') ?>images/card/card2.jpg" alt="">
                    <div class="card-info">
            ...
            <div class="col-sm-6">
                <div class="card-bx stacked card">
                    <img src="<?= base_url('assets/') ?>images/card/card4.jpg" alt="">
                    <div class="card-info">
                        <p class="mb-1 text-white fs-14">Main Balance</p>
                        <div class="d-flex justify-content-between">
                            <h2 class="num-text text-white mb-5 font-w600">$673,412.66</h2>
                        ...
                        <div class="testimonial-one px-4 owl-right-nav owl-carousel owl-loaded owl-drag">
                            <div class="items">
                                <div class="text-center">
                                    <img class="mb-3 rounded" src="<?= base_url('assets/') ?>images/contacts/Untitled-1.jpg" alt="">
                            ...
                            <div class="items">
                                <div class="text-center">
                                    <img class="mb-3 rounded" src="<?= base_url('assets/') ?>images/contacts/Untitled-2.jpg" alt="">
                            ...
                            <div class="items">
                                <div class="text-center">
                                    <img class="mb-3 rounded" src="<?= base_url('assets/') ?>images/contacts/Untitled-3.jpg" alt="">
                            ...
                            <div class="items">
                                <div class="text-center">
                                    <img class="mb-3 rounded" src="<?= base_url('assets/') ?>images/contacts/Untitled-4.jpg" alt="">
                            ...
                            <div class="items">
                                <div class="text-center">
                                    <img class="mb-3 rounded" src="<?= base_url('assets/') ?>images/contacts/Untitled-5.jpg" alt="">
